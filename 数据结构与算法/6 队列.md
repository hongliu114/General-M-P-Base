...
## 顺序队列
f和r的操作要点：
每次出入队都要对f或r步进,然后读写数组![[数据结构与算法/assets/Pasted image 20260105105100.png]]

队空判定：`front == rear`
## 循环顺序队列
![[数据结构与算法/assets/Pasted image 20260105105121.png]]
...
## 链式队列
队头在头结点后，队尾在链尾
![[数据结构与算法/assets/Pasted image 20260105105629.png]]

队空条件：`front->next == NULL`

![[数据结构与算法/assets/Pasted image 20260105105722.png]]
## 应用
### 解决约瑟夫斯问题
方法：
...
![[数据结构与算法/assets/Pasted image 20260105112452.png]]
### 2
通过栈操作对第1题中的后缀表达式进行求值，并画出栈中内容的变化过程。
![[数据结构与算法/assets/Pasted image 20260105112520.png]]
