...
其中，
$$\begin{aligned}&r\left(t\right)——系统的输入;\\&c\left(t\right)——系统的响应;\\&H\left(t\right)——算子。\end{aligned}$$
#### 脉冲函数
...
![[自动控制理论/assets/Pasted image 20250911124857.png]]
### 积分环节
$$G\left(s\right)=\frac{C\left(s\right)}{R\left(s\right)}=\frac{K}{s}$$
常记：
$$K=\frac{1}{\tau}$$
![[自动控制理论/assets/Pasted image 20250918104628.png]]
### 微分环节
#### 理想微分环节
$$G\left(s\right)=\frac{C\left(s\right)}{R\left(s\right)}=\tau s$$
![[自动控制理论/assets/Pasted image 20250918104656.png]]
#### 比例微分环节
一个微分环节和一个惯性环节的串联组合：
$$G(s)=\frac{U_\mathrm{o}(s)}{U_\mathrm{i}(s)}=\frac{\tau s}{\tau s+1}$$
![[自动控制理论/assets/Pasted image 20250918104917.png]]
...
![[自动控制理论/assets/Pasted image 20250918105145.png]]
### 滞后环节
$$G\left(s\right)=\frac{C\left(s\right)}{R\left(s\right)}=\mathrm{e}^{-\tau s}$$
![[自动控制理论/assets/Pasted image 20250918105214.png]]
### 相似系统
...
![[自动控制理论/assets/Pasted image 20250918105417.png]]
### 串联
![[自动控制理论/assets/Pasted image 20250918105449.png]]
$$G\left(s\right)=\prod_{i=1}^nG_i\left(s\right)$$
上式尽在无**负载效应**时成立。
> [!note] 负载效应
> 负载效应是指例如电路中负载电阻漏电，导致环节空载和负载时传递函数不一样，或者说前一缓解缓解的输出量受后面环节的影响的效应。
### 并联
![[自动控制理论/assets/Pasted image 20250918105959.png]]
$$G\begin{pmatrix}s\end{pmatrix}=\sum_{i=1}^nG_i\begin{pmatrix}s\end{pmatrix}$$
### 反馈
![[自动控制理论/assets/Pasted image 20250918110647.png]]
...
$$\frac{C\left(s\right)}{R\left(s\right)}=\frac{G\left(s\right)}{1-G\left(s\right)H\left(s\right)}$$
### 框图变换
![[自动控制理论/assets/Pasted image 20250918111111.png]]
### 方框图简化法求系统传递函数的一般步骤
...
![[自动控制理论/assets/Pasted image 20250918114234.png]]
![[自动控制理论/assets/Pasted image 20250918114255.png]]
### 梅逊公式
