...
#### 扰动误差传递函数
**不考虑参考输入$R(s)$**
$$\boldsymbol{\Phi}_\mathrm{n}\left(s\right)=\frac{E_{n}(s)}{N(s)}=\frac{\boldsymbol{G}_\mathrm{o}\left(s\right)}{\boldsymbol{1}+\boldsymbol{G}_\mathrm{c}\left(s\right)\boldsymbol{G}_\mathrm{o}\left(s\right)\boldsymbol{H}\left(s\right)}=\frac{\boldsymbol{G}_\mathrm{o}\left(s\right)}{\boldsymbol{1}+\boldsymbol{G}\left(s\right)}$$
