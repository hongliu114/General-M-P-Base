...
![[自动控制理论/assets/Pasted image 20250918115423.png]]
#### 单位阶跃函数
...
![[自动控制理论/assets/Pasted image 20250918125403.png]]
其拉普拉斯变换：
$$R\left(s\right)=\frac{A}{s^{2}}$$
### 抛物线函数
$$r(t)=\begin{cases}0,&\quad t<0\\\\At^2,&\quad t\geq0&\end{cases}$$
![[自动控制理论/assets/Pasted image 20250918125706.png]]
...
![[自动控制理论/assets/Pasted image 20250918130240.png]]
单位脉冲函数的拉普拉斯变换：
$$
R(s)=1
$$
...
## 时域响应的性能指标
### 暂态性能指标
![[自动控制理论/assets/Pasted image 20250918161004.png]]
#### 最大超调量$M_{p}$
...
### 一阶系统（又称为单位负反馈）
![[自动控制理论/assets/Pasted image 20250918161358.png]]
传递函数：$$\frac{C\left(s\right)}{R\left(s\right)}=\frac{1}{\tau s+1}$$
其有负实数极点$-\frac{1}{\tau}$
### 单位阶跃响应
![[自动控制理论/assets/Pasted image 20250918161644.png]]
...
| $4\tau$ | 98%      | 调整时间$t_{s}$ |
### 单位脉冲响应
![[自动控制理论/assets/Pasted image 20250918162108.png]]
$$C(s)=\frac{1}{\tau s+1}$$
$$g\left(t\right)=c\left(t\right)=\frac{1}{\tau}\mathrm{e}^{-t/\tau}$$
调整时间$t_{s}=3\tau$
### 单位斜坡响应
![[自动控制理论/assets/Pasted image 20250918162240.png]]
...
## 二阶系统的暂态响应
### 二阶系统
![[自动控制理论/assets/Pasted image 20250918162613.png]]
...
具体变化趋势如下图：
![[自动控制理论/assets/Pasted image 20250918182205.png]]
...
系统极点在坐标系中的位置也有规律。
![[自动控制理论/assets/Pasted image 20250918182846.png]]
...
### 加入比例微分环节的二阶系统的响应
![[自动控制理论/assets/Pasted image 20250927214106.png]]
![[自动控制理论/assets/Pasted image 20250927214151.png]]
加入PD环节之后的特点：
...
然后按公式写出后续的系数：
![[自动控制理论/assets/Pasted image 20250928132538.png]]
其中新增的系数都有以下规律：
...
把各个系数写成一个矩阵：
![[自动控制理论/assets/Pasted image 20250928164932.png]]
...
![[自动控制理论/assets/Pasted image 20250928181510.png]]
上图是本节和下一节最重要的图。
